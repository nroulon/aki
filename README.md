...
```
pipx install https://github.com/nroulon/nroulon/releases/download/vv0.10.7-rc3/aki-v0.10.7-rc3-py3-none-any.whl
```
...
| aki.volumes._name_.container_name_dependencies | array of container name to remove when the volume's container is removed                                     | []                        | ['aki_sample_elastic']                                      |
